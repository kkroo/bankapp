...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-bank-app.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-bank-app)

This repository contains the source code for the [Bank App](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.bank.app).

Please see the [issues](https://github.com.bank.app/com-bank-app/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Bank App? Ask away on the [com-bank-app discussion forum](https://groups.google.com/forum/#!forum/com-bank-app).

<a href="https://play.google.com/store/apps/details?id=com.bank.app" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.bank.app__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.bank.app__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.bank.app.R__) will now be renamed
...
signed with a different key.  Manually uninstall Bank App from your device and
...
Bank App is a result of a template project I've developed over the years as well as
...
Bank App is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.bank.app/com-bank-app/contributors) on
...
[pull requests](https://github.com.bank.app/com-bank-app/pulls).
